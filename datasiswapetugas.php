		...
		<div class="nav">
			<div class="nav-list">
				<ul>
					...
					<li class="nav-link">
						<a href="transaksipetugas.php" class="nav-list1">Transaksi</a>
					</li>
					<li class="nav-link aktif">
						<a href="datasiswapetugas.php" class="nav-list1">Data Siswa</a>
					</li>
					<li class="nav-link">
						<a href="petugasindex.php" class="nav-list1">Beranda</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<table border="1" class="table">
			...
			<tr align="center">
				...
				<td><?php echo $d['telp']; ?></td>
					...
					<td>
						<a href="edittesiswapetugas.php?id_user=<?php echo $d['id_user']; ?>">Edit</a>
						|
						<a href="hapussiswapetugas.php?id_user=<?php echo $d['id_user']; ?> ">Hapus</a>
					</td>		
			</tr>
		<?php	
		}
