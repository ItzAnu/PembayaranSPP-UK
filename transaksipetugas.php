		...
		<div class="nav">
			<div class="nav-list">
				<ul>
					...
					<li class="nav-link">
						<a href="transaksipetugas.php" class="nav-list1 transaksi aktif">Transaksi</a>
					</li>
					<li class="nav-link">
		...
		<table border="1" class="table">
			...
			<tr align="center">
				...
				<td><?php echo $d['id_pembayaran']; ?></td>
					...
					<td>
						<a href="hapustransaksipetugas.php?id_pembayaran=<?php echo $d['id_pembayaran']; ?> ">Hapus</a>
					</td>		
			</tr>
		<?php	
		}
